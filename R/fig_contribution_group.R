...
fig_contribution_group_ <- function() {
  ...
  fig_contribution_group(direct, indirect, "2010_2015")
  ...
  fig_contribution_group(direct, indirect, "2016_2021")
}
...
#' @export
fig_contribution_group <- function(direct, indirect, period, out = here::here("figures", "contribution")) {
  # =~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=#
  # Libraries
  # =~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=#
  library(magrittr)
