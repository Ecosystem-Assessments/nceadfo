#' Data XXXX : Offshore oil and gas
#'
#' Offshore oil and gas, it's probably best to get data from CNSOPB.
#'
#' @keywords
#' @keywords
#' @keywords
#'
#' @source https://www.cnsopb.ns.ca/what-we-do/lands-management/maps-and-coordinates
#' @source https://callforbids.ca/data-environment/gis-information  (See link to “General Shapefiles”)
#' @source https://callforbids.ca/geoscience-and-data
#'
#' @export
#'
