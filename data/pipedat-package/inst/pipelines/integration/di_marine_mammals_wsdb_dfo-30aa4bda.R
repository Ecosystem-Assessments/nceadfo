#' @eval get_name("30aa4bda")
#'
#' @eval get_description("30aa4bda")
#'
#' @eval dp_params()
#' @eval di_params()
...
#'
#' @keywords pipeline_id: 30aa4bda
#'
#' @examples
#' \dontrun{
#' di_30aa4bda()
#' }
di_30aa4bda <- function(bbox = NULL, bbox_crs = NULL, timespan = NULL, grid = NULL, ...) {
  ...
  if (!exist$integrated) {
    ...
    # =~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~= #
    # Formatted data
    name <- gsub("a5b97616", "30aa4bda", name)
